...
if (process.env.NODE_ENV !== 'development') {
    ...
    transports.push(new winston_1.default.transports.File({ filename: 'logs/error.log', level: 'error' }));
    transports.push(new winston_1.default.transports.File({ filename: 'logs/traces.log' }));
}
else {
    transports.push(new winston_1.default.transports.Console({
